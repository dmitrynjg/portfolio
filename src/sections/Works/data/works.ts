const works = [
  {
    ...
    typePoster: 'video',
    desc: `Nosis.io - это уникальный проект, предоставляющий пользователям возможность 
  ...
  },
  {
    ...
    typePoster: 'video',
    desc: `Free Task - это персональное веб-приложение для создания папок в которых хранятся задачи`,
  },
];
